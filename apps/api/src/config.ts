...
const envSchema = z.object({
  ...
  SESSION_RECORD_RETENTION_DAYS: z.coerce.number().int().positive().max(3650).default(90),
  RECOVERY_REQUEST_RETENTION_DAYS: z.coerce.number().int().positive().max(3650).default(90),
